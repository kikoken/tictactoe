...
$(document).ready(() => {
    ...
    function _checkWinner() {
        ...
        if (gameboard.length > 3) {
            ...
            winPlayer = _horizontalEvaluation() || _verticalEvaluation() || _diagonalValidation();
    ...
    function _diagonalValidation() {
        ...
        let diagonal;
        for (let i = 0; i < 2; i++) {
            if (i == 0) diagonal = gameboard[i] == gameboard[i + 4] == gameboard[i + 8];else diagonal = gameboard[i + 1] == gameboard[i + 3] == gameboard[i + 5];
